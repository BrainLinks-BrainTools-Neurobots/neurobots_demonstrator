...
StackView { 
    ...
    Rectangle {
        ...
        property var actions : {
            //"actions": function(){ selector.actionMenu() ; },
            "goals": function(){ selector.goalMenu() ; },
        ...
        FocusScope {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            ArgumentList {
                                model: modelData //retrieves one element of the outer model
            ...
            Rectangle {
                ...
                ListView {
                    ...
                    onCurrentIndexChanged: selector.displayStatus(currentIndex)
            ...
            Component {
                ...
                Item {
                    ...
                    Image {
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        horizontalAlignment: Image.AlignHCenter
                        source: actionStatus == Constants["EXECUTABLE"] ? "../../images/ok.png" : ""
                        opacity: 0.3
                    }

                    function planActionClick() {
                        list.currentIndex = index
                        selector.selectAction(index)
                    }
                    ...
                    Rectangle {
                        ...
                        // border.color: "black"
                        // border.width: 2
                        visible : actionStatus != Constants["EXECUTABLE"]
                        color: {
//                            console.log(actionStatus);
                            if (actionStatus == Constants["EXECUTED"])
                                return "lightgrey"
                            else if (actionStatus == Constants["FAILED"])
                                return "red"
                            else if (actionStatus == Constants["UNSUCCESSFUL"])
                                return "red"
                            else if (actionStatus == Constants["IN_PROGRESS"])
                                return "green"
                            else return "white"
                        }
                    }
            ...
            onActiveFocusChanged: {
                ...
                for (var i = planView.currentIndex; i < planView.count; i++) {
                    ...
                    if (item.actionStatus === Constants["EXECUTABLE"]) {
                        new_index = i;
                        executable = true;
                        break;
                    }
            ...
            function teleop_up() {
//                console.log("called teleop up", planView.currentIndex);
                if (planView.currentIndex > 0) {
                    var next = planView.model[planView.currentIndex - 1]
                    if (next.actionStatus == Constants["EXECUTABLE"]) {
                        planView.decrementCurrentIndex()
                    }
                }
            }
            function teleop_down() {
//                console.log("called teleop down", planView.currentIndex);
            ...
            function teleop_select() {
//                console.log("called teleop select", planView.currentIndex);
                planView.currentItem.planActionClick()
            }
            function teleop_back() {
//                console.log("called teleop back");
                selector.back()
            }
        }
