...
#     
    ...
    try:
        if ADD_MODE:
            ...
            object_message.attribute_names = ['contains', 'position', 'is-open', 'type', 'name']
            object_message.attribute_values = ['22 serialization::archive 10 0 0 1 0 0 0 3 5 empty', '22 serialization::archive 10 0 0 1 0 0 0 3 9 shelfleft', '22 serialization::archive 10 0 0 1 0 0 0 2 1', '22 serialization::archive 10 0 0 1 0 0 0 3 3 cup', '22 serialization::archive 10 0 0 1 0 0 0 3 %d %s'% (len(objname), objname)]       
