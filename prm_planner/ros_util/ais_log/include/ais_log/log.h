...
#define LOG_FATAL_F(FORMAT, ARGS) CommanderLogger::getInstance()->printFatal(__FILENAME_ONLY__, __LINE__) << boost::format{FORMAT} % ARGS << std::endl;
#define LOG_ERROR(TEXT) CommanderLogger::getInstance()->printError(__FILENAME_ONLY__, __LINE__) << TEXT << std::endl;
#define LOG_ERROR_F(FORMAT, ARGS) CommanderLogger::getInstance()->printError(__FILENAME_ONLY__, __LINE__) << boost::format{FORMAT} % ARGS << std::endl;
#define LOG_WARNING(TEXT) CommanderLogger::getInstance()->printWarning(__FILENAME_ONLY__, __LINE__) << TEXT << std::endl;
#define LOG_WARNING_F(FORMAT, ARGS) CommanderLogger::getInstance()->printWarning(__FILENAME_ONLY__, __LINE__) << boost::format{FORMAT} % ARGS << std::endl;
#define LOG_INFO(TEXT) CommanderLogger::getInstance()->printInfo(__FILENAME_ONLY__, __LINE__) << TEXT << std::endl;
#define LOG_INFO_F(FORMAT, ARGS) CommanderLogger::getInstance()->printInfo(__FILENAME_ONLY__, __LINE__) << boost::format{FORMAT} % ARGS << std::endl;
#define LOG_DEBUG(TEXT) CommanderLogger::getInstance()->printDebug(__FILENAME_ONLY__, __LINE__) << TEXT << std::endl;
#define LOG_DEBUG_F(FORMAT, ARGS) CommanderLogger::getInstance()->printDebug(__FILENAME_ONLY__, __LINE__) << boost::format{FORMAT} % ARGS << std::endl;
