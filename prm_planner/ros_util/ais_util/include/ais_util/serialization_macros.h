...
#define SERIALIZATION_METHOD_LOAD_EMPTY(OTHER_STUFF_TO_DO)\
		private:\
			template<class Archive>\
			void load(Archive & ar,\
					const unsigned int version)\
...
#define SERIALIZATION_METHOD_SAVE_EMPTY(OTHER_STUFF_TO_DO)\
		private:\
			template<class Archive>\
			void save(Archive & ar,\
					const unsigned int version) const\
...
#define SERIALIZATION_WITH_PARENT_METHOD_EMPTY(PARENT)\
		private:\
			friend class boost::serialization::access;\
			template<class Archive>\
			void serialize(Archive & ar,\
...
#define SERIALIZATION_METHOD_SPLITTED_LOAD_WITH_PARENT(PARENT, VARIABLES, OTHER_STUFF_TO_DO_LOAD)\
	SERIALIZATION_METHOD_INIT()\
	SERIALIZATION_METHOD_LOAD(boost::serialization::base_object<PARENT>(*this) & VARIABLES, OTHER_STUFF_TO_DO_LOAD)\
	SERIALIZATION_METHOD_SAVE(boost::serialization::base_object<PARENT>(*this) & VARIABLES,)\
	BOOST_SERIALIZATION_SPLIT_MEMBER()

#define SERIALIZATION_METHOD_SPLITTED_LOAD_EMPTY_WITH_PARENT(PARENT, OTHER_STUFF_TO_DO_LOAD)\
	SERIALIZATION_METHOD_INIT()\
	SERIALIZATION_METHOD_LOAD(boost::serialization::base_object<PARENT>(*this), OTHER_STUFF_TO_DO_LOAD)\
	SERIALIZATION_METHOD_SAVE(boost::serialization::base_object<PARENT>(*this),)\
	BOOST_SERIALIZATION_SPLIT_MEMBER()
...
//start 1.5.8, boost has corresponding serializers
...
{
	boost::shared_ptr<Value> bsp = to_boost_ptr(t);
	ar & bsp;
}
