...
//        }
    ...
    else //Unconstraint motion planning
    {
        if(m_single_extend_step == true)
        {
            ...
            stepTowardsRandSample(tree->name, nn_node, extend_node, m_unconstraint_extend_step_factor);
            ...
            tree_extend_NN = feasibility_checker->isEdgeValid(e_new);
...
void BiRRTstarMultiRobotPlanner::drawBaseEllipse()
{
